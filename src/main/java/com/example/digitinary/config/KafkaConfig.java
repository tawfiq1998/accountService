...
public class KafkaConfig {
    ...
    @Bean
    public EventConsumer eventConsumer(AccountKafkaServiceImpl accountKafkaService) {
        return new EventConsumer(accountKafkaService);
    }
    ...
    @Bean
    public AccountKafkaServiceImpl accountKafkaService(AccountRepository accountRepository, EventProducer eventProducer, AccountMapper accountMapper) {
        return new AccountKafkaServiceImpl(accountRepository, eventProducer, accountMapper);
    }
}
